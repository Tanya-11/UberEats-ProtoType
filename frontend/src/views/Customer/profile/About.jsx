...
export const About = (props) => {
    ...
    const submitCustomerData = () => {
        ...
        const setPhoto = Axios.post('http://3.143.169.133:3001/upload-pic', formData, config)
    ...
    const submit = async (event) => {
        ...
        //  const result = await Axios.post('http://3.143.169.133:3001/upload-pic', formData, config)
        //  setImage(result.data.imagePath)
        //  setImage('image/3fe4ee4f70dfcfc6cf0fc7acb09ea0f5')
        const result = await Axios.get('http://3.143.169.133:3001/fetch-file')
        ...
        <div>
            {image && (
                <img
                    ...
                    src={`http://3.143.169.133:3000/${image}`}
                />
            )}
            <label>
                Name:
