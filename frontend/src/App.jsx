...
import ViewOrder from './views/Restaurant/view-orders'
import CompleteOrders from './views/Restaurant/completed-orders'
import ActiveOrders from './views/Restaurant/active-orders'
function App() {
    return (
